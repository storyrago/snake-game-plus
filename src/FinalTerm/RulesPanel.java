...
public class RulesPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        addSection(rulesPanel, "점수", new String[]{"빨간 원 - 일반 먹이 (10점)", "황금 원 - 레어 먹이 (30점)"});
        // [텍스트 수정] 포탈 색상 업데이트 (보라/파랑)
        addSection(rulesPanel, "특수 아이템", new String[]{"보라/파랑 원 - 포탈 (이동 가능)", "회색 사각형 - 장애물 (망치로 파괴)", "H - 망치, S - 가위, ? - 랜덤박스"});
